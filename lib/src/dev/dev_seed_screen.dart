...
class _DevSeedScreenState extends State<DevSeedScreen> {
  ...
  // Structure exacte du MachineModel.toJson()
  static const List<Map<String, dynamic>> _testMachines = [
    {
      'location': {'lat': 48.6290, 'lng': 2.4400, 'address': 'Université d\'Évry, 91000 Évry-Courcouronnes', 'geohash': null},
      'characteristics': {'capacityKg': 8, 'brand': 'Bosch', 'description': '[Lave-linge] Machine récente (2022), très silencieuse. Parking gratuit. — Lessive fournie.'},
      'pricing': {'pricePerWash': 4.5, 'currency': 'EUR'},
      'media': {'photoUrls': []},
      'status': 'AVAILABLE',
      'stats': {'rating': 4.8, 'reviewCount': 24},
      'availability': {'availableDays': [1, 2, 3, 4, 5, 6, 7], 'startTimeHour': 8, 'endTimeHour': 21},
    },
    {
      'location': {'lat': 48.6310, 'lng': 2.4420, 'address': 'Centre Commercial Évry 2, 91000 Évry', 'geohash': null},
      ...
      'availability': {'availableDays': [1, 2, 3, 4, 5], 'startTimeHour': 9, 'endTimeHour': 20},
    },
    {
    ...
    {
      'location': {'lat': 48.6325, 'lng': 2.4350, 'address': 'Préfecture de l\'Essonne, 91000 Évry', 'geohash': null},
      ...
      'availability': {'availableDays': [6, 7], 'startTimeHour': 10, 'endTimeHour': 18},
    },
    {
      'location': {'lat': 48.6270, 'lng': 2.4450, 'address': 'Parc des Loges, 91000 Évry', 'geohash': null},
      ...
      'availability': {'availableDays': [1, 2, 3, 4, 5], 'startTimeHour': 8, 'endTimeHour': 19},
    },
    {
      'location': {'lat': 48.6350, 'lng': 2.4480, 'address': 'Courcouronnes Centre, 91080 Courcouronnes', 'geohash': null},
    ...
    {
      'location': {'lat': 48.6250, 'lng': 2.4300, 'address': 'Bras de Fer, 91000 Évry', 'geohash': null},
      'characteristics': {'capacityKg': 8, 'brand': 'Candy', 'description': '[Lave-linge] Machine connectée, accessible 7j/7 de 6h à 23h.'},
    ...
    {
      'location': {'lat': 48.6400, 'lng': 2.4500, 'address': 'Route de Corbeil, 91000 Évry', 'geohash': null},
    ...
    },
    {
      ...
      'characteristics': {'capacityKg': 8, 'brand': 'AEG', 'description': '[Lave-linge] AEG ProSteam, élimine 99,9% des bactéries. Idéal pour le linge sensible.'},
    ...
    {
      'location': {'lat': 48.6305, 'lng': 2.4500, 'address': 'Bords de Seine, 91000 Évry', 'geohash': null},
      'characteristics': {'capacityKg': 9, 'brand': 'Siemens', 'description': '[Lave-linge] Siemens iQ500, classe A, économique en eau et en énergie.'},
